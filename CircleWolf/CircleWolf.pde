...
void setup() {
  ...
  source = loadImage("mojave.JPG");
  source.loadPixels();

  // loop from first pixel to final pixel, image width * height - 1 ex. 725*550=398750,-1=398749
  for (int position = 0; position <= 398749; position += 1) {
